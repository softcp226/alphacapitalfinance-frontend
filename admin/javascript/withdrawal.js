...
const handle_approve_withdrawal = async (btn, withdrawal_request) => {
  ...
  try {
    const response = await fetch(
      "https://alphacapitalfinance-backend.glitch.me/api/admin/withdrawal/fetch/withdrawal/approval",
...
const handle_delete_withdrawal = async (btn, withdrawal_request) => {
  ...
  try {
    const response = await fetch(
      "https://alphacapitalfinance-backend.glitch.me/api/admin/withdrawal/fetch/withdrawal/delete",
      {
        method: "DELETE",
        headers: { "content-type": "application/json" },
        body: JSON.stringify({ token, admin, withdrawal_request }),
...
(async () => {
  ...
  try {
    const response = await fetch(
      "https://alphacapitalfinance-backend.glitch.me/api/admin/withdrawal/fetch",
      {
        method: "POST",
        headers: { "content-type": "application/json" },
